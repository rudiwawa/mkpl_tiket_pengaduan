                            ...
                            <div class="profile-sidebar">
                                ...
                                <div class="portlet light profile-sidebar-portlet bordered">
                                    ...
                                    <div class="profile-userpic">
                                        <img src="<?php echo base_url(); ?>/assets/apps/img/user/<?php echo $key['foto']?>" class="img-responsive" alt=""> </div>
                                    <!-- END SIDEBAR USERPIC -->
                                    <!-- SIDEBAR USER TITLE -->
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="row list-separated profile-stat">
                                        <div class="col-md-4 col-sm-4 col-xs-6">
                                            <div class="uppercase profile-stat-title"> <a href="<?php echo site_url('C_user/tiket/')?>" > <?php echo $total?> </a> </div>
                                            <div class="uppercase profile-stat-text"> Tickets </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-xs-6">
                                            <div class="uppercase profile-stat-title"> <a href="<?php echo site_url('C_user/tiket/0')?>" > <?php echo $open?> </a> </div>
                                            <div class="uppercase profile-stat-text">  Open </div>
                                        </div>
                                        <div class="col-md-4 col-sm-4 col-xs-6">
                                            <div class="uppercase profile-stat-title"> <a href="<?php echo site_url('C_user/tiket/1')?>" > <?php echo $close?> </a> </div>
