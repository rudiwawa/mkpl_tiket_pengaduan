                                    ...
                                    <div class="col-md-10">
                                        <div class="portlet light bordered">
                                            <div class="portlet-body">
                                                        <form role="form" action="<?php echo site_url('C_user_admin/newUser') ?>" enctype="multipart/form-data" method="post" >
                                                        <div class="form-body">
                                                        <small><?php echo $this->session->flashdata('msg');?></small>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" name="no_telepon" /> </div>
                                                            <div class="form-group">
                                                            ...
                                                            <div class="margin-top-10">
                                                                <button type="submit" id="register-submit-btn" class="btn btn-success"> Create </button>
                                                                <a href="<?php echo site_url('C_user_admin') ?>" class="btn default"> Cancel </a>
                                                            </div>
                                                        </div>
                                                        </form>
