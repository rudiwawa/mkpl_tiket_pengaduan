                                        ...
                                        <div class="portlet light bordered">
                                            <div class="portlet-title tabbable-line">
                                                ...
                                                <ul class="nav nav-tabs">
                                                    <li class="active">
                                                        <a href="#tab_1_1" data-toggle="tab">Kategori 1</a>
                                                    </li>
                                                    <li>
                                                        <a href="#tab_1_2" data-toggle="tab">Kategori 2</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <?php
                                                foreach ($konteks->result_array() as $key4) {
                                                    $judul = $key4['judul'];
                                                    $desk = $key4['deskripsi'];
                                                }
                                            ?>
                                            <div class="portlet-body">
                                                <div class="tab-content">
                                                    ...
                                                    <form class="form" action="<?php echo site_url('C_context/editKat1') ?>" enctype="multipart/form-data" method="post">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label>Title</label>
                                                        <div class="input-icon right">
                                                            <i class=" font-blue"></i>
                                                            <input type="text" class="form-control" name="subject" placeholder="Subject" value="<?php if(isset($judul)){echo $judul;}  ?>"> </div>
                                                    </div>
                                                    <div class="form-group last">
                                                        <div class="col-md-12">
                                                            <textarea class="form-control" name="message" id="summernote_1"><?php if(isset($desk)){echo $desk;} ?></textarea>
                                                       </div>
                                                    </div>
                                                    </div>
                                                    ...
                                                    <form class="form" action="<?php echo site_url('C_context/newKat2') ?>" enctype="multipart/form-data" method="post">
                                                    <div class="form-body">
                                                        <div class="form-group">
                                                            <label>Title</label>
                                                        <div class="input-icon right">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="kategori" class="form-control">
                                                            <?php
                                                                foreach ($kategori->result_array() as $key5) {
                                                                    $id = $key5['id_sub'];
                                                                    $nama = $key5['nama'];
                               
                                                            ?>
                                                            <option value="<?php if(isset($id)){echo $id;} ?>"><?php if(isset($nama)){echo $nama;}} ?></option>';
                                                        </select>   
                                                    </div>
                                                    <div class="form-group last">
                                                        <div class="col-md-12">
                                                            <textarea class="form-control" name="desk" id="summernote_2"></textarea>
                                                       </div>
                                                    </div>
                                                    </div>
                                                    <div class="form-actions right">
