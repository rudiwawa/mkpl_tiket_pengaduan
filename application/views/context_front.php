                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="caption font-green-sunglo">
                                        <h3><i class="fa fa-newspaper-o font-green-sunglo"></i>
                                        <span class="caption-subject bold uppercase">Front Page</span></h3>
                                    </div>
                                 <?php
                                ...
                                <div class="portlet-body form">
                                    <form class="form" action="<?php echo site_url('C_context/editFront') ?>" enctype="multipart/form-data" method="post">
                                        <div class="form-body">
