                                    ...
                                    <div class="col-md-12">
                                        <div class="portlet light bordered">
                                            <div class="portlet-title tabbable-line">
                                                ...
                                                ?>
                                                    <form class="form" action="<?php echo site_url('C_context/editKat2/'.$sid) ?>" enctype="multipart/form-data" method="post">
                                                    <div class="form-body">
                                                    ...
                                                    <div class="form-group last">
                                                        <div class="col-md-12">
                                                            <textarea class="form-control" name="desk" id="summernote_2"><?php if(isset($desk)){echo $desk;}  ?></textarea>
                                                       </div>
                                                    </div>
                                                    </div>
