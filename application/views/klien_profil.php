                            ...
                            <div class="profile-sidebar">
                                ...
                                <div class="portlet light profile-sidebar-portlet bordered">
                                    ...
                                    <img src="<?php echo base_url(); ?>/assets/apps/img/client/<?php echo $key['foto']; ?>" class="img-responsive" alt=""> </div>
                                        <?php $this->session->set_userdata('ses_foto',$key['foto']);?>
                                    <!-- END SIDEBAR USERPIC -->
                                    <!-- SIDEBAR USER TITLE -->
                                ...
                                <div class="portlet-body">
                                    <form role="form">
                                                            <div class="form-group">
                                                                ...
                                                                <label type="text" class="form-control"> <?php echo $key['fullname'];?></label></div>
                                                            <div class="form-group">
                                                                <label class="control-label">Instance : </label>
                                                                <label type="text" class="form-control"> <?php echo $key['instansi'];?> </label></div>
                                                            <div class="form-group">
                                                                <label class="control-label">Province : </label>
                                                                <label type="text" class="form-control" > <?php echo $key['provinsi'];?> </label></div>
                                                            <div class="form-group">
                                                                <label class="control-label">City : </label>
                                                                <label type="text" class="form-control" > <?php echo $key['kota'];?> </label></div>
                                                            <div class="form-group">
                                                                <label class="control-label">Address : </label>
                                                                <label type="text" class="form-control" > <?php echo $key['alamat_instansi'];?> </label></div>
                                                            <div class="form-group">
                                                                <label class="control-label">Email : </label>
                                                                <label type="text" class="form-control" > <?php echo $key['email'];?> </div>
                                                            <div class="form-group">
                                                                <label class="control-label">Phone Number : </label>
                                                                <label type="text" class="form-control" > <?php echo $key['nomor_telepon'];}?> </label></div>
                                                        </form>
                                </div>
                            </div>
                            <!-- END PROFILE CONTENT -->
